...
When we are sampling distributions of these 7 balls into the 5 urns, the number of stars and bars will not change. We will always have 7 stars, and 5 + 1 bars. If we want to generate a new string (sample a new distribution), then all we need to do is determine the position of the bars.
