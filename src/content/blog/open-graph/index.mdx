...
```html caption="Example of Open Graph meta tags"
...
Determined to find a simpler approach, I kept searching. As I continued poking around, I found [this blog post](https://arne.me/blog/static-og-images-in-astro) by Arne Bahlo. Instead of rendering a page with Chrome and taking a screenshot, Arne uses an HTML and CSS to SVG rendering library called [Satori](https://github.com/vercel/satori).
...
```ts link=https://github.com/HesitantlyHuman/personal-website/blob/f37be61af901b61a59ee1ee623d2ef90bf7aad86/scripts/generate-og-images.tsx#L18-L57 lines=18-22,31
type OgPage = {
    outputPath: string;
    title: string;
    summary: string;
...
```ts link=https://github.com/HesitantlyHuman/personal-website/blob/f37be61af901b61a59ee1ee623d2ef90bf7aad86/scripts/generate-og-images.tsx#L287-L291 lines=59-65,287
...
```ts link=https://github.com/HesitantlyHuman/personal-website/blob/f37be61af901b61a59ee1ee623d2ef90bf7aad86/scripts/generate-og-images.tsx#L108-L143
...
```tsx link=https://github.com/HesitantlyHuman/personal-website/blob/f37be61af901b61a59ee1ee623d2ef90bf7aad86/scripts/generate-og-images.tsx#L178-L255
...
```ts link=https://github.com/HesitantlyHuman/personal-website/blob/f37be61af901b61a59ee1ee623d2ef90bf7aad86/scripts/generate-og-images.tsx#L257
...
```ts link=https://github.com/HesitantlyHuman/personal-website/blob/f37be61af901b61a59ee1ee623d2ef90bf7aad86/scripts/generate-og-images.tsx#L293-L318
...
```astro link=https://github.com/HesitantlyHuman/personal-website/blob/f37be61af901b61a59ee1ee623d2ef90bf7aad86/src/pages/projects/index.astro#L22-L26
<PageLayout
  title={PROJECTS.TITLE}
...
```astro link=https://github.com/HesitantlyHuman/personal-website/blob/f37be61af901b61a59ee1ee623d2ef90bf7aad86/src/pages/projects/%5B...slug%5D.astro#L22-L32
<PageLayout
...
```astro link=https://github.com/HesitantlyHuman/personal-website/blob/f37be61af901b61a59ee1ee623d2ef90bf7aad86/src/components/BaseHead.astro#L131-L132
