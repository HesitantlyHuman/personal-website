...
{/* 
TODO:
- Explain why using an action model is better than using a value model (Because the action model is an easier task. The value model also has a bunch more random effects added in to the signal by all the things that could happen until the end of the round)
- Talk about the litmus test for evaluating whether you have good data and targets to train a model on: "Could I do this? Could I learn this task?"
*/}
