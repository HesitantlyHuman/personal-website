...
My upgrade to the code snippet component achieved two things: First, it added the features I needed--linking to code bases, line-numbers, and line highlighting--and it also brought the code snippets more in line with Astro Sphere's existing crisp, minimal style.
...
And here is the hero of my site, which I am sure you have seen already, but will be included in the name of completeness anyway:
